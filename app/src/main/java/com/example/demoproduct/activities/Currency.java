...
public class Currency {
    ...
    public static String convertToIndianCurrency(String num) {
        ...
        String finalwords;
        if (Rupees.equalsIgnoreCase("")&&paise.equalsIgnoreCase("")){

            finalwords="Zero Rupees "  + " Zero Paisa Only";

        }else if (paise.equalsIgnoreCase("")){

            finalwords="Rupees " + Rupees + " Only";

        } else {

            finalwords="Rupees " + Rupees + paise + " Paisa Only";
        }
